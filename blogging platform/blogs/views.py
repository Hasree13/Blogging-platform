...
def owner_dashboard(request):
    ...
    # authors (ADDED u.avatar_id)
    cur.execute("""
        SELECT u.first_name, u.last_name, a.author_id, u.avatar_id
        FROM authors a
        JOIN users u ON a.author_id=u.user_id
        WHERE a.publi_id=%s
    """, (publi_id,))
    ...
    # requests (ADDED u.avatar_id)
    cur.execute("""
        SELECT r.request_id, u.first_name, u.last_name, u.avatar_id
